...
#define MINIMUM_POWERED_TORQUE 0.025
#define MINIMUM_DRAG_TORQUE 0.177
#define STROKE_DETECTION_TYPE STROKE_DETECTION_TORQUE
#define MINIMUM_RECOVERY_SLOPE_MARGIN 0.0002 // Only relevant if STROKE_DETECTION_TYPE is either BOTH or TORQUE
