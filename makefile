...
TEST_SRCS:=$(wildcard $(LIB_DIR)/utils/*.cpp) $(wildcard $(LIB_DIR)/rower/*.cpp) $(wildcard $(LIB_DIR)/peripherals/*service.cpp) $(wildcard $(LIB_DIR)/peripherals/*.cpp) $(wildcard $(UNIT_TEST_DIR)/include/*.cpp) $(wildcard $(TEST_SRC))
